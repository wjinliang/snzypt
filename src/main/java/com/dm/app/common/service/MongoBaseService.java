package com.dm.app.common.service;
...
/**
 * mongo操作相关的service层接口
 * @author LiaoGang
 * @param <T>
 * @param <PK>
 */
public interface MongoBaseService<T extends Serializable, PK extends Serializable> {
	...
	List<T> findByPropertys(String key, Object[] ids);
}
