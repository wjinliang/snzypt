...
/**
 * 
 * @description 动物卫生防疫所【基本信息】
 * @author huoge
 */
@Document(collection="m_YZ_DWWSFYS_JBXX")
public class DwwsfysJbxx implements Serializable {
	/**
	 * 
	 */
	...
	public boolean equals(Object obj) {
		...
		if (getClass() != obj.getClass())
			return false;
		DwwsfysJbxx other = (DwwsfysJbxx) obj;
		if (id == null) {
			if (other.id != null)
				return false;
