...
/**
 * @description 蛋鸡养殖场【基本信息】
 * @author huoge
 */
@Document(collection="m_YZ_DANJI_JBXX")
public class DanjiJbxx implements Serializable {
