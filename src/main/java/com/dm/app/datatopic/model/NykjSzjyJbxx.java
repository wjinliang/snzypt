...
/**
 * @description 农用科技:数字家园
 * @author lyh
 */
@Document(collection="m_KJZC_KJFW_NCSZJY_JBXX")
public class NykjSzjyJbxx implements Serializable {
	...
	public boolean equals(Object obj) {
		...
		if (getClass() != obj.getClass())
			return false;
		NykjSzjyJbxx other = (NykjSzjyJbxx) obj;
		if (id == null) {
			if (other.id != null)
				return false;
