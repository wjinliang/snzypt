                    ...
                    <div class="mgt15">
                    	<div class="real-map-info">
                            ...
                            <div class="real-map-con">
                                 <ul class="map-list clearfix">
                                     <li class="pull-left">
                                         <a href="#snqy" data-toggle="tab" onclick="clearFeatures();">
                                            <img src="/html/sn-static/static/image/icon5.png" width="50" height="46" alt="涉农企业">
                                            <p>涉农企业</p>
                                         </a>
                                     </li>
                                     <li class="pull-left">
                                         <a href="#zzsc" data-toggle="tab" onclick="clearFeatures();">
                                            <img src="/html/sn-static/static/image/icon6.png" width="39" height="46" alt="种植生产">
                                            <p>种植生产</p>
                                         </a>
                                     </li>
                                     <li class="pull-left">
                                         <a href="#xmsc" data-toggle="tab" onclick="clearFeatures();">
                                            <img src="/html/sn-static/static/image/icon7.png" width="39" height="46" alt="畜牧养殖">
                                            <p>畜牧养殖</p>
                                         </a>
                                     </li>
                                     <li class="pull-left">
                                         <a href="#sczy" data-toggle="tab" onclick="clearFeatures();">
                                            <img src="/html/sn-static/static/image/icon8.png" width="55" height="46" alt="市场资源">
                                            <p>市场资源</p>
                                         </a>
                                     </li>
                                     <li class="pull-left">
                                         <a href="#nykj" data-toggle="tab"  onclick="clearFeatures();">
                        ...
                        <div class="detail">
                        	<div class="detail-title icon-bg5">
                                <span class="blue">详细内容</span>
                            </div>
                            <div class="detail-con">
                                <div class="panel-body">
                                    <div class="tab-content">
					<div class="tab-pane fade in" id="xmsc">
						<div class="checkbox" onclick="queryBySQL('YZ_ST_YZC@221');"><label><input type="checkbox" value="">1养殖场</label></div>
						<div class="checkbox" onclick="queryBySQL('YZ_ST_YANG@221');"><label><input type="checkbox" value="">羊养殖场</label></div>
						<div class="checkbox" onclick="queryBySQL('YZ_ST_YA@221');"><label><input type="checkbox" value="">鸭养殖场</label></div>
						<div class="checkbox" onclick="queryBySQL('YZ_ST_SHENGZHU@221');"><label><input type="checkbox" value="">生猪养殖场</label></div>
						<div class="checkbox" onclick="queryBySQL('YZ_ST_DANJI@221');"><label><input type="checkbox" value="">蛋鸡养殖场</label></div>
						<div class="checkbox" onclick="queryBySQL('YZ_ST_SCYZC@221');"><label><input type="checkbox" value="">水产养殖场</label></div>
						<div class="checkbox" onclick="queryBySQL('YZ_ST_ROUNIU@221');"><label><input type="checkbox" value="">肉牛养殖场</label></div>
						<div class="checkbox" onclick="queryBySQL('YZ_ST_ROUJI@221');"><label><input type="checkbox" value="">肉鸡养殖场</label></div>
						<div class="checkbox" onclick="queryBySQL('YZ_ST_NAINIU@221');"><label><input type="checkbox" value="">奶牛养殖场</label></div>
						<div class="checkbox" onclick="queryBySQL('ZYDP_ST_YZ_XQLZC@221');"><label><input type="checkbox" value="">畜禽良种场</label></div>
						<div class="checkbox" onclick="queryBySQL('YZ_ST_DWZLDW@221');"><label><input type="checkbox" value="">动物诊疗单位</label></div>
						<div class="checkbox" onclick="queryBySQL('YZ_ST_DWWSFYS@221');"><label><input type="checkbox" value="">动物卫生防疫所</label></div>
					</div>
					<div class="tab-pane fade in" id="zzsc">
						<div class="checkbox" onclick="queryBySQL('LY_ST_GY@221');"><label><input type="checkbox" value="">果园基地</label></div>
						<div class="checkbox" onclick="queryBySQL('LY_ST_MP@221');"><label><input type="checkbox" value="">苗圃基地</label></div>
						<div class="checkbox" onclick="queryBySQL('LY_ST_HHJD@221');"><label><input type="checkbox" value="">花卉基地</label></div>	
						<div class="checkbox" onclick="queryBySQL('ZZ_ST_SPBASE@221');"><label><input type="checkbox" value="">三品基地</label></div>
					</div>
					<div class="tab-pane fade in" id="sczy">
						<div class="checkbox" onclick="queryBySQL('SCDP_ST_JYSC@221');"><label><input type="checkbox" value="">经营市场</label></div>
						<div class="checkbox" onclick="queryBySQL('SCDP_ST_CGXPT_NFSC@221');"><label><input type="checkbox" value="">农副市场</label></div>
						<div class="checkbox" onclick="queryBySQL('SCDP_ST_CGXPT_CS@221');"><label><input type="checkbox" value="">超市</label></div>
					</div>
					<div class="tab-pane fade in" id="nykj">
						<div class="checkbox" onclick="queryBySQL('KJZC_KJFW_ST_XTYGZZ@221');"><label><input type="checkbox" value="">协调员工作站</label></div>
						<div class="checkbox" onclick="queryBySQL('KJZC_KJFW_ST_TJXX@221');"><label><input type="checkbox" value="">田间学校</label></div>
						<div class="checkbox" onclick="queryBySQL('KJ_ST_NYJSTGZ@221');"><label><input type="checkbox" value="">农业技术推广站</label></div>
						<div class="checkbox" onclick="queryBySQL('KJ_ST_KJSFYQ@221');"><label><input type="checkbox" value="">科技示范园区</label></div>
					</div>
					<div class="tab-pane fade in active" id="snqy">
						<div class="checkbox" onclick="queryBySQL('ZH_ST_SNQY@221');"><label><input type="checkbox" value="">涉农企业</label></div>
						<div class="checkbox" onclick="queryBySQL('ZH_ST_NJGQY@221');"><label><input type="checkbox" value="">农加工企业</label></div>
						<div class="checkbox" onclick="queryBySQL('ZH_ST_NJFWZZ@221');"><label><input type="checkbox" value="">农机服务组织</label></div>
						<div class="checkbox" onclick="queryBySQL('ZH_ST_GGNYSFY@221');"><label><input type="checkbox" value="">观光农业示范园</label></div>
						<div class="checkbox" onclick="queryBySQL('YZ_ST_SYJYQY@221');"><label><input type="checkbox" value="">兽药经营企业</label></div>
						<div class="checkbox" onclick="queryBySQL('ZYDP_ST_LY_GGGY@221');"><label><input type="checkbox" value="">观光果园</label></div>
						<div class="checkbox" onclick="queryBySQL('YZ_ST_SLQY@221');"><label><input type="checkbox" value="">饲料企业</label></div>
					</div>
                                </div>
                            </div>
                        </div>
