            	...
            	<div class="col-md-3 col-lg-3" style="position:relative; padding-right:0px;">
                    ...
                    <div class="data-situation">
                        ...
                        <ul class="data-situation-list">
                        	<li class="clearfix"><span>数据来源数</span><span id="sys-num" class="num_style"><@dictItemListDirective  code="C06">
								${items?size}</@dictItemListDirective>个</span></li>
                            <li class="clearfix"><span>整合部门数</span><span id="depart-num" class="num_style"><@dictItemListDirective  code="C07">
								${items?size}</@dictItemListDirective>个</span></li>
