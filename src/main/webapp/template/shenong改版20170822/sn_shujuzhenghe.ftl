    ...
    <div class="wrapper" style="background:#f5f5f5;">
		...
		<@dictItemListDirective  code="C06">
                    <table width="100%" cellpadding="0" cellspacing="0">
                        <tr>
                            <td width="30%"><div class="data_state"><span class="zh_num">${items?size}</span>大涉农部门</div></td>
                            <td width="70%"></td>
                        </tr>
						<#list items as item>
                              <tr><td align="right"><span>[${item.itemDesc!}]</span></td><td><span class="sys" style="padding-left:0">${item.itemName!}</span>发起数据共享</td></tr>
						</#list>
                        <!--<tr><td align="right"><span>[2016年10月]</span></td><td><span class="sys" style="padding-left:0">北京市城乡经济信息中心</span>发起数据共享</td></tr>
                        <tr><td align="right"><span>[2016年10月]</span></td><td><span class="sys" style="padding-left:0">北京市城乡经济信息中心</span>发起数据共享</td></tr>-->
                    </table>
