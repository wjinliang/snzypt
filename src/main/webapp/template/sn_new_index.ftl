	...
	$('.source-nav li').bind('click',function(){
	  ...
	  window.location.href = "/${application}/portal/channel/sjzylb/41_1.htm?param="+parentNodes[0].code;
        ...
        $.get('/html/sn-static209/cdn/js/beijing.json', function (geoJson) {
          ...
          var geoCoordMap = {
            海淀区: [116.304782,39.966128],
            朝阳区: [116.449767,39.927254],
            东城区: [116.422731,39.934568],
            西城区: [116.3724,39.918562],
            房山区: [116.149892,39.755039],
            大兴区: [116.348097,39.732805],
            通州区: [116.735389,39.922342],
            昌平区: [116.23786,40.226799],
            顺义区: [116.667284,40.156062],
            丰台区: [116.293111,39.865036],
            石景山区: [116.229603,39.912008],
            怀柔区: [116.638526,40.322545],
            平谷区: [117.12805,40.147034],
            延庆区: [115.981186,40.462693],
            密云区: [116.849427,40.382955],
            门头沟区: [116.108265,39.946491],
          }
          //数据信息
          var data = [
            { name: '海淀区', value: 199 },
