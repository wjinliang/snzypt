                                  ...
                                  <style>
                                   ...
                                   $(function() {
                                        new uploadPreview({ UpBtn: "imageFile", DivShow: "imgdiv", ImgShow: "imgShow" ,callback:showUpImageBtn});
                                         CKEDITOR.replace( 'introduce',{uiColor: '#9AB8F3'});                        
                                    });
                                    function save(num)
                                    {
                                       var data = CKEDITOR.instances.introduce.getData();
                                       $("#introduce").val(data);
                                       ...
                                       if(flag)
                                       {
                                          form.action="./saveVideo?status="+num;
                                          form.submit();
                                       }
                                    }
                                    function uploadFile(htmlElement)
                                    {
                                      if($('#videoFile').val().indexOf('flv')!=-1 || $('#videoFile').val().indexOf('mp4')!=-1)
                                      {
                                       
                                        $(htmlElement).next('span').remove(); 
                                        $(htmlElement).after("<span class='vMiddle loading'>上传中…………<span>");
                                        $.ajaxFileUpload({
                                          url: basePath+"/cms/attachmentOther/multipleUpload?mediaType=video",
                                          type: "POST",
                                          secureuri: false,
                                     ...
                                     function upload(htmlElement)
                                   {
                                    ...
                                    $.ajaxFileUpload({
                                        url: basePath+"/cms/attachmentOther/singleUpload?mediaType=video",
                                        type: "POST",
                                        secureuri: false,
                                    ...
                                    function removeNext(htmlElements)
                                        ...
                                        function checkName(htmlElement)
                                      {
                                        ...
                                        if(!checkName(form.director))
                                         {
                                          console.log(form.director);
                                              flag = false;
                                         }
                                         if(!checkName(form.actor))
                                         {
                                              flag = false;
                                         }
                       ...
                       <div class="videochannel-floor fn-clear">
                          <div class="videosortpannel" style="height:560px;padding-top:20px;">
                                     <div class="slidevideo" id="content">
                                      <form action="./saveVideo" id="videoForm" method="post">
                                         <ul class="zcxyh-list" >
                                            <li>
                                                <label class="label"><span class="need">*</span> 片名 </label>
                                                <input type="text" value="" name="name" id="videoname" class="inputxt" />
                                            </li>
                                            <li>
                                                <label class="label"><span class="need">*</span> 导演 </label>
                                                <input type="text" value="" name="director" id="director" class="inputxt" />
                                            </li>
                                            <li>
                                                <label class="label"><span class="need">*</span> 演员 </label>
                                                <input type="text" value="" name="actor" id="actor" class="inputxt" />
                                            </li>
                                            ...
                                            <li>
                                             ...
                                             <li style="height:220px;">
                                                <label class="label" style="height:200px;line-height:198x;"><span class="need">*</span> 影片海报图 </label>
                                             ...
                                             <li style="height:415px;">
                                                <label class="label">影片介绍 </label>
                                                <div style="float:left;width:800px;">
                                                <textarea  id="introduce" name="introduce"  rows="10" cols="80"></textarea>
                                                </div>
                                            </li>
                                             <li>
                                                <label class="label"><span class="need">*</span> 上传视频</label>
