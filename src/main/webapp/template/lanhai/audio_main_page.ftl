<!DOCTYPE html>
                                  ...
                                  <script type="text/javascript"  src="${htmlFolder}/js/jquery-1.11.3.min.js"></script>
                                   ...
                                   <script>
                                        $(document).ready(function(){
                                              $("#content").load("./audioContent");   
                                        });
                                        function goTo(num)
                                        {
                                           $("#content").load("./audioContent",{pageNum:num});   
                                        }
                                        function check(id,pageNum,type)
                                        {
                                                $.ajax({
                                                  url:"./checkOrDelete",
                                                  data:{id:id,type:type,channelType:"6"},
                                                  type:"post",
                       ...
                       <div class="videochannel-floor fn-clear">
                          <div class="videosortpannel" style="height:660px;padding-top:5px;">
                            <div style="text-align:center"><a href="./uploadPage?channelType=6" style="width:200px;height:80px;line-height: 50px;padding: 4px 20px;background: #016bc1 none repeat scroll 0 0;color: #ffffff;">我要上传</a></div>
