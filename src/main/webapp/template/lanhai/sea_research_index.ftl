<!doctype html>
                                        	...
                                        	<@contentListDirective channelId=101 pageSize=6 pageNum=1 titleLeft=30 order=1>
                                        	<div class="newspic">     
                                        	  <div class="scrollpic">
                                        	    <div id="featured">
                                        	  ...
                                        	  <div class="pictext">
                                                ...
                                                <div class="newsmain slidenews" >
                                                    ...
                                                    <div class="bd">
                                                       <!--选卡1-->
                                                       <ul> 
                                           		<@contentListDirective channelId=97 pageSize=8 pageNum=1 titleLeft=30 order=1>
                                            			<#list contents as cmsContent>
                                            ...
                                            <div class="newschannel-floor fn-clear">
                                               <div class="moretabs news-cont" >
                                                 <div class="hd">
                                                       <span class="more">
                                                         <@channelListDirective channelId=own order=1 excludeIds="101,97">
