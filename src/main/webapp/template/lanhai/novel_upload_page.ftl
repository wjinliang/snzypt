                                  ...
                                  <style>
                                   ...
                                   $(function() {
                                    ...
                                    function save(num)
                                    {
                                       ...
                                       if(flag)
                                       {
                                          form.action="./saveNovel?status="+num;
                                          form.submit();
                                       }
                                    }
                                    function uploadFile(htmlElement)
                                    {
                                      if($('#videoFile').val().indexOf('rar')!=-1 || $('#videoFile').val().indexOf('txt')!=-1 || $('#videoFile').val().indexOf('zip')!=-1)
                                      {
                          ...
                          <div class="videosortpannel" style="height:560px;padding-top:20px;">
                                     <div class="slidevideo" id="content">
                                      <form action="./saveAudio" id="videoForm" method="post">
                                         <ul class="zcxyh-list" >
                                            <li>
                                                <label class="label"><span class="need">*</span> 小说名 </label>
                                                <input type="text" value="" name="name" id="novelName" class="inputxt" />
                                            </li>
                                            <li>
                                                <label class="label"><span class="need">*</span> 作者 </label>
                                                <input type="text" value="" name="author" id="author" class="inputxt" />
                                            </li>
                                            ...
                                            <li>
                                             ...
                                             <li style="height:220px;">
                                                <label class="label" style="height:200px;line-height:198x;"><span class="need">*</span> 小说封面图 </label>
                                             ...
                                             <li style="height:415px;">
                                                <label class="label">小说介绍</label>
                                                <div style="float:left;width:800px;">
                                                <textarea  id="introduce" name="introduce"  rows="10" cols="80"></textarea>
                                                </div>
                                            </li>
                                             <li>
                                                <label class="label"><span class="need">*</span> 上传小说</label>
