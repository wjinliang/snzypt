...
<body>
                    	...
                    	<div class="data_reduction">
                            ...
                            <div class="data_reductionCon">
                                ...
                                <!--<li class="firstOne">
                                    ...
                                    <li>
                                    	<h3 style="color:#1c8fe5; margin:0px; font-size:14px;">整合系统</h3>
                                    ...
                                    <li>
                                    	<h3 style="color:#1c8fe5; margin:0px; font-size:14px;">整合数据总量</h3>
                                        <div class="clearfix data_part">
                                        	<div> 1,204,513条 </div>
                                        </div>
                                    </li>
   ...
   $(function(){
	...
	<@tableListDirective type=1 >
		...
		var url = "${application!}/portal/data/grid/bCIbFy4Y_1.htm"+"?param="+word;
