        	...
        	<div class="row mgt15">
            	<div class="col-md-12">
                	<ul class="agric_list clearfix" id="agric_list">
                        ...
                        <li>
                        	<a href="../xxny/index.htm" target="_blank">
                ...
                <div class="col-md-9" style="padding-left:0px;">
                	<ul class="agric_list1 clearfix">
                    	<li>
                            ...
                            <div class="topic_icon topic_icon1 mgt10"><span class="topict_tit4" style="margin-right:30px;">3936</span>个</div>
                        </li>
                        <li>
                        	<div>
                            ...
                            <div class="topic_icon topic_icon2 mgt10"><span class="topict_tit4" style="margin-right:30px;">539.5</span>万人</div>
                        </li>
                        <li>
                        	<div>
                            ...
                            <div class="topic_icon topic_icon3 mgt10"><span class="topict_tit4" style="margin-right:30px;">221.4</span>万户</div>
                        </li>
                        <li class="mgt20">
                        	<div>
                            ...
                            <div class="topic_icon topic_icon4 mgt10"><span class="topict_tit4" style="margin-right:30px;">239.8348</span>万人</div>
                        </li>
                        <li class="mgt20">
                        	<div>
                            ...
                            <div class="topic_icon topic_icon5 mgt10"><span class="topict_tit4" style="margin-right:30px;">100.7382</span>万户</div>
                        </li>
						 <li class="mgt20">
                        	<div>
                            ...
                            <div class="topic_icon topic_icon5 mgt10"><span class="topict_tit4" style="margin-right:30px;">154.5133</span>万人</div>
                        </li>
                    </ul>	
                </div>
                <div class="col-md-3">
