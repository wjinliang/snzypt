      ...
      <div class="jh-main">
          <div class="panel panel-default panel2">
              ...
              <div class="panel-body">
                  <div class="jh-article-title fontSize22 text-center color-green pdTop1em2"><span>${own.title!}</span></div>
		  ...
		  <div class="row text-center mgb20">
			 投票时间为&nbsp;&nbsp;:&nbsp;&nbsp;  &nbsp;&nbsp;-&nbsp;&nbsp;   
  		    ...
  		    <form id="toupiao">
			<#list own.votes as cmsVote>
  			<input type="hidden" value="${cmsVote.id}" name="voteId">
                          <ul class="zmhd-wsdc-dlist">
			  <span>${cmsVote.title}</span>
  			<#list cmsVote.option as option>
  			<li><a href="javascript:void(0);" data-id="${option.id}"><span class="border-gray"><span class="glyphicon glyphicon-ok color-green"></span></span>${option.option!}</a> </li>	
                          ...
                          <div class="pdTop1em2">
                              ...
                              <div class="text-center pdTop1em21">
                                  <a class="btn btn-default btn-download result" href="${own.id}r.htm" >&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;查看结果&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;</a>
                              </div>
                          </div>
                      </div>
                  </div>
